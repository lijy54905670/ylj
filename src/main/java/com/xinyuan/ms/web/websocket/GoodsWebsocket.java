 ...
 */
@ServerEndpoint(value = "/goodswebsocket/{userid}/{roomName}")
@Component
public class GoodsWebsocket {
    //@Autowired
    ...
    public void onClose(Session session) {
        for(SessionidRoom s:sessionidRoomList){
            if(session.getId().equals(s.getSession().getId())){
                ...
                //System.out.println(s.getUserid()+"删除");
